              ...
              <div className="space-y-4">
                ...
                <div className="border-t pt-4">
                  ...
                  {profileLoading ? (
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <StatBox icon={Package} label="إجمالي الطلبات" value={driverStats.totalOrders.toLocaleString("en-US")} />
                      <StatBox icon={Package} label="طلبات مكتملة" value={driverStats.completedOrders.toLocaleString("en-US")} />
                      <StatBox icon={Wallet} label="إجمالي الأرباح" value={driverStats.totalEarnings.toLocaleString("en-US", { maximumFractionDigits: 2 })} />
                      <StatBox icon={Star} label="متوسط التقييم" value={driverStats.avgRating != null ? driverStats.avgRating.toFixed(1) : "0"} />
                    </div>
                  ) : consumerStats ? (
                    <div className="grid grid-cols-2 gap-3">
                      <StatBox icon={Package} label="إجمالي الطلبات" value={consumerStats.totalOrders.toLocaleString("en-US")} />
                      <StatBox icon={Package} label="طلبات مكتملة" value={consumerStats.completedOrders.toLocaleString("en-US")} />
                      <StatBox icon={Wallet} label="إجمالي الإنفاق" value={consumerStats.totalSpent.toLocaleString("en-US", { maximumFractionDigits: 2 })} />
                    </div>
                  ) : null}
                </div>
